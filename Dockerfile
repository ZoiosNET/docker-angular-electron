...
RUN apt-get update
RUN apt-get install -y nodejs libgtk-3.0 libgconf-2-4 libasound2 libxtst6 libxss1 libnss3 libgbm1 xvfb wine wine32 wine64 libwine libwine:i386 fonts-wine mono-complete build-essential chromium-browser
